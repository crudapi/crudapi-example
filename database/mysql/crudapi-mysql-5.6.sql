...
CREATE TABLE `ca_sys_moduleLine` (
  ...
  `createdDate` datetime NOT NULL COMMENT '创建时间',
  `lastModifiedDate` datetime DEFAULT NULL COMMENT '修改时间',
  `moduleId` bigint(20) DEFAULT NULL COMMENT '模块编号',
  `tableId` bigint(20) DEFAULT NULL COMMENT '表编号'
...
--
-- 表的结构 `SPRING_SESSION_ATTRIBUTES`
--
...
--
-- 表的索引 `SPRING_SESSION_ATTRIBUTES`
--
...
--
ALTER TABLE `ca_sys_module`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '编号', AUTO_INCREMENT=5;

--
-- 使用表AUTO_INCREMENT `ca_sys_moduleLine`
--
ALTER TABLE `ca_sys_moduleLine`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '编号', AUTO_INCREMENT=12;

--
-- 使用表AUTO_INCREMENT `ca_tableFormBuilder`
--
ALTER TABLE `ca_tableFormBuilder`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '编号';
